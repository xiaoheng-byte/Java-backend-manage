...
public class orderQueryTime1  extends JFrame implements ActionListener {
		...
		String s2=t2.getText();
			...
			new orderQueryTime1();
				...
				return;
   	 			...
   	 			this.dispose();
   	 			new orderQuery();
   	 			new QueryJFrame(ShopkeeperOperation.selectTotalNumAndTotalPriceOfOrderInfoByTime(s1, s2, LoginJudge.user_id));

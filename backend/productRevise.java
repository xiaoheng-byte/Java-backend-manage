...
public class productRevise  extends JFrame implements ActionListener{
	JLabel l2 = new JLabel("商品id：");
	JTextField t1=new JTextField(15);
	JLabel l3 = new JLabel("新商品名：");
	JTextField t2=new JTextField(15);
	JLabel l7 = new JLabel("新类别：");
	JTextField t6=new JTextField(20);
	JLabel l4 = new JLabel("新价格：");
			...
			new productRevise();
   	 		...
   	 		if(s1.length()==0||s2.length()==0||s3.length()==0||s4.length()==0||s5.length()==0) {
	 			...
	 			return;
   	 			...
   	 			ShopkeeperOperation.updateProduct(s1,s2,s6,s4,s3,s5,LoginJudge.user_id);
